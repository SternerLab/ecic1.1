...
// [[Rcpp::export]]
List normDatSimRcpp(arma::vec ns,List MLEList,int noSimDraws)
{
...
// [[Rcpp::export]]
List ICCompsRcpp(List yList,Rcpp::StringVector models)
{
...
// [[Rcpp::export]]
List simDGOFsRcpp(List yList,Rcpp::StringVector models)
{
    int nLen = yList.length(); // number of sample sizes
    List returnList(nLen); // the return list that indexes the sample sizes
    for(int i=0;i<nLen;i++) // indexes sample size
